...
class WechatpayTradeWapPayContentBuilder{
	...
	public function setSceneInfo($wap_url, $wap_name)
	{
		$this->scene_info = ["h5_info" => ["type"=>"Wap","wap_url"=>$wap_url,"wap_name"=>$wap_name]];
